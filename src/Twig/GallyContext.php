...
class GallyContext
{
    ...
    {
        // RepositoryInterface is a BC alias (sylius/resource-bundle) that doesn't propagate its
        // generic template through to PHPStan, so findAll() resolves as ResourceInterface[] here.
