...
{
    // Kept in sync with ActiveFilterResolver::CATEGORY_FIELD.
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        ...
        if (!$categoryFieldAdded) {
            ...
            if (null !== $categoryId) {
                $builder->add(self::CATEGORY_FIELD, HiddenType::class, ['data' => $categoryId]);
            }
        }
    }
    ...
    {
        $builder->add(self::CATEGORY_FIELD, HiddenType::class, [
    ...
    private function addCategoryField(FormBuilderInterface $builder, Aggregation $aggregation): void
    {
        ...
        $builder->add(self::CATEGORY_FIELD, SelectFilterType::class, [
    ...
    private function getCurrentCategoryId(): ?string
    {
        ...
        $categoryId = $gallyCriteria[self::CATEGORY_FIELD] ?? null;
